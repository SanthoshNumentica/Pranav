  ...
  <div class="space-y-6">
    ...
    <div
      ...
      <div class="flex items-center gap-3">
        <button v-if="modulePermissions.canAdd" @click="openCreateModal"
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex flex-wrap items-center gap-3 flex-1">
          ...
          <div class="relative w-full md:w-72 group">
            ...
            <input v-model="filters.search" type="text" placeholder="Search Name, ID, MRN, Mobile..."
          ...
          <div class="relative w-full md:w-48">
            <Select v-model="filters.status" @update:modelValue="() => fetchPatients(1)">
    ...
    <div
      ...
      <PatientsTable :patients="patients" :loading="loading" :permissions="modulePermissions"
        :start-index="pagination?.from || 1" @view-info="handleView" @edit="handleEdit" @delete="handleDelete"
    ...
    <PatientFormDialog :is-open="isFormModalOpen" :patient="selectedPatientForForm" @close="closeFormModal"
      @saved="handleSaved" />

    <PatientInfoDialog :is-open="isInfoModalOpen" :patient="selectedPatient" @close="isInfoModalOpen = false"
      @edit="handleEditFromInfo" />

    <ConfirmationModal :is-open="isDeleteModalOpen" title="Delete Patient"
      :description="`Are you sure you want to delete patient ${patientToDelete?.name}? This action will move the record to trash.`"
      confirm-label="Delete Patient" variant="danger" :icon="TrashIcon" :loading="isDeleting"
