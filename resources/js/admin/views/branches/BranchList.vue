  ...
  <div class="space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex flex-wrap items-center gap-3 flex-1">
          ...
          <div class="relative w-full md:w-72 group">
            ...
            <input v-model="filters.search" type="text" placeholder="Search Name, Code..."
    ...
    <div
      ...
      <BranchesTable :branches="branches" :loading="loading"
        :permissions="{ ...modulePermissions, canStatus: hasStatusPermission }" @edit="handleEdit"
        @view-info="handleView" @delete="handleDelete" @toggle-status="handleToggleStatus" />
      <!-- Pagination -->
      <Pagination v-if="pagination" :pagination="pagination" @page-change="handlePageChange" />
    </div>

    <!-- Modals -->
    <BranchFormDialog :is-open="isFormModalOpen" :branch="selectedBranch" @close="isFormModalOpen = false"
      @saved="fetchBranches" />

    <BranchInfoDialog :is-open="isInfoModalOpen" :branch="selectedBranch" :can-edit="modulePermissions.canEdit"
      @close="isInfoModalOpen = false" @edit="handleEditFromInfo" />

    <ConfirmationModal :is-open="isDeleteModalOpen" title="Delete Branch"
      :description="`Are you sure you want to delete branch ${branchToDelete?.name}?`" confirm-label="Delete Branch"
