            ...
            <DialogPanel
              ...
              <div class="relative bg-primary px-6 py-8 sm:px-10 text-white overflow-hidden shrink-0">
                ...
                <div class="relative flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-3">
                    <button @click="$emit('edit', patient)"
              ...
              <div class="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                  <div v-for="(field, label) in detailedInfo" :key="label" class="space-y-1">
                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 block ml-1">{{ label
                      }}</span>
                    <p
                ...
                <div v-if="patient?.case_reports?.length > 0" class="space-y-4 pt-4 border-t border-slate-100">
                  ...
                  <div
                    ...
                    <div v-for="report in patient.case_reports.slice(0, 5)" :key="report.id"
