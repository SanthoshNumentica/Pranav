<template>
  <div class="overflow-x-auto custom-scrollbar">
    <table class="w-full border-separate border-spacing-0">
      <thead>
        <tr class="border-b border-slate-200 bg-slate-50/50">
          ...
          <th class="px-3 py-4 text-left text-[11px] font-bold text-slate-500 uppercase tracking-wider">Patient ID</th>
      ...
      <tbody class="divide-y divide-slate-100 italic">
        ...
        >
          ...
          <td class="px-3 py-4">
            <span class="text-sm font-semibold text-slate-900">{{ patient.name }}</span>
          </td>
    ...
    <div v-if="patients.length === 0" class="text-center py-20 animate-in fade-in duration-500">
...
<script setup>
import { Eye, User as UserIcon } from 'lucide-vue-next';
