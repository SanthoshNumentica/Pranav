  ...
  >
    ...
    <div class="h-20 flex items-center px-6 gap-3 shrink-0 border-b border-slate-100">
      ...
      <div v-if="!isCollapsed" class="flex flex-col overflow-hidden animate-in fade-in slide-in-from-left-4">
        <span class="font-bold text-base text-slate-900 tracking-tight leading-none uppercase">Scan Center</span>
        ...
        <div class="space-y-1">
          <div 
            ...
            :class="cn(
              ...
              reportsOpen && !isCollapsed ? 'bg-primary/5 text-primary font-semibold' : 'text-slate-500 hover:bg-slate-100/80 hover:text-slate-900'
            )"
          >
    ...
    <div class="p-4 border-t border-slate-100 bg-white/50 backdrop-blur-md">
      ...
      >
        ...
        <div class="flex flex-col min-w-0">
          <span class="text-xs font-bold text-slate-700 truncate">{{ user?.name || 'Loading...' }}</span>
...
const navMain = [
  ...
  { title: 'Case Reports', url: '/case-reports', icon: OrdersIcon },
  { title: 'Patients', url: '/patients', icon: InvoicesIcon },
  { title: 'Doctors', url: '/doctors', icon: PaymentsIcon },
  { title: 'Scan Types', url: '/masters/scan-types', icon: PieChartIcon },
