<template>
  <div class="flex justify-end gap-1.5 transition-opacity duration-200">
    <button
      v-if="showView && permissions.canView"
    ...
    <button
      ...
      class="flex h-8 w-8 items-center justify-center rounded-xl text-emerald-600 hover:bg-emerald-600/10 transition-all active:scale-90"
      :title="whatsappTitle"
    >
    ...
    <button
      v-if="showDelete && permissions.canDelete"
