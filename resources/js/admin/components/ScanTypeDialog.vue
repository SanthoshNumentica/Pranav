              ...
              <div class="bg-white px-6 py-6 border-b border-slate-100">
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-3">
                    ...
                    >
                      {{ mode === "edit" ? "Edit Scan Type" : "Add Scan Type" }}
                    </DialogTitle>
                  </div>
                  <button
                    @click.stop="onClose"
                      ...
                      >
                        <div class="relative flex-1">
                          <input
                            ...
                            class="w-full bg-slate-50/50 border-slate-100 group-hover:bg-white group-hover:border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-primary/20 focus:border-primary transition-all duration-200"
                            required
                          />
                        </div>
                        <button
